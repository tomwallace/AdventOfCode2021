...
public class DayTwentyThree : IAdventProblemSet
{
    ...
    public string PartA()
    {
        ...
        var result = FindLeastEnergy(NormalInput(filePath, false));
    ...
    {
        string filePath = @"TwentyThree\DayTwentyThreeInput.txt";
        var result = FindLeastEnergy(NormalInput(filePath, true));

        return result.ToString();
    }

    public string NormalInput(string filePath, bool extend)
    {
